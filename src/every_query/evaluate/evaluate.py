...
``EQ_select_model`` did) lives in the ``EveryQueryExperiments`` repo per the #82 inventory.
...
recover from git history if needed.  The cross-model leaderboard lives in the
``EveryQueryExperiments`` repo; tracked on #83.
"""
