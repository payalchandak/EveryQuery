...
pred = evaluate(obj, Query(code='ECG',duration=minutes('5y'), offset=0))

censor_auc = roc_auc_score(pred['censor_target'], pred['censor_logits'])
occurs_auc = roc_auc_score(pred['occurs_target'], pred['occurs_logits'])
print(censor_auc, occurs_auc)
